                        ...
                        if(task.isSuccessful()) {
                            ...
                            FirebaseDatabase.getInstance().getReference("Users")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText(Registration.this,"User has been registerd sucessfully",Toast.LENGTH_LONG).show();
                                        progressBar.setVisibility(View.GONE);

                                    }else{
                                        Toast.makeText(Registration.this,"Failed try again",Toast.LENGTH_LONG).show();
                                        progressBar.setVisibility(View.GONE);
