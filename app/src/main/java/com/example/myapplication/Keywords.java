...
public class Keywords extends AppCompatActivity implements View.OnClickListener {
    ImageView backbtn;
    Button next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("file:///android_asset/keywords.html");
    }
